...
class Contatto {
	 ...
	 * @param cognomeContatto cognome del contatto
	 * @param indirizzoContatto indirizzo del contatto
	 * @param numeroTelefonoContatto numero di telefono del contatto
	 */
	Contatto(String nomeContatto, String cognomeContatto, String indirizzoContatto, String numeroTelefonoContatto){
		nome = nomeContatto;
		cognome = cognomeContatto;
		indirizzo = indirizzoContatto;
		numeroTelefono = numeroTelefonoContatto;
	}
}
