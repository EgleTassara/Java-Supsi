...
class Cerchio {
	 ...
	 * 
	 * @param raggioCerchio raggio del cerchio
	 * @param xCentro       coordinata x del centro del cerchio
	 * @param yCentro       coordinata y del centro del cerchio
	 */
	Cerchio(double raggioCerchio, double xCentro, double yCentro) {
		raggio = raggioCerchio == 0 ? Math.random() * 10 + 1 : Math.abs(raggioCerchio);
		x = xCentro;
		y = yCentro;
	}
}
...
public class CerchioTest {
	 ...
	 * 
	 * @param cerchio
	 *                cerchio di cui calcolare l'area
	 ...
	 * 
	 * @param cerchi
	 *               array contenente le referenze ai cerchi da utilizzare per il
	 *               calcolo della
