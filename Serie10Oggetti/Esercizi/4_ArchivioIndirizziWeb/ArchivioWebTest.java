...
class VoceArchivio {
	 ...
	 * @param nomeSitoWeb nome del sito
	 * @param indirizzoSitoWeb indirizzo web
	 * @param descrizioneSitoWeb breve descrizione
	 */
	VoceArchivio(String nomeSitoWeb, String indirizzoSitoWeb, String descrizioneSitoWeb){
		nomeSito = nomeSitoWeb;
		indirizzo = indirizzoSitoWeb;
		descrizione = descrizioneSitoWeb;
	}
}
...
public class ArchivioWebTest {
	 ...
	 * 
	 * @param archivio
	 *            archivio al quale aggiungere una voce
	 */
	 ...
	 * 
	 * @param archivio
	 *            archivio dal quale rimuovere la voce
	 */
	 ...
	 * 
	 * @param archivio
	 *            archivio nel quale eseguire la ricerca
	 */
