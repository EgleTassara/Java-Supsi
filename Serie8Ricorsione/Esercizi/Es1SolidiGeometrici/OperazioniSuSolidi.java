...
public class OperazioniSuSolidi {
     ...
     * 
     * @param domande
     *            array contenente le domande da porre all'utilizzatore
     * @param input
     *            Scanner utilizzato per leggere i dati da tastiera
     ...
     * 
     * @param frase
     *            frase descrittiva da mostrare a schermo
     * @param valore
     *            valore da mostrare a schermo
     */
     ...
     * 
     * @param lato1
     *            primo lato del parallelepipedo
     * @param lato2
     *            secondo lato del parallelepipedo
     * @param lato3
     *            terzo lato del parallelepipedo
